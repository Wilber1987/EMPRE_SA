ALTER TABLE EMPRE_SA.[security].Security_Permissions
ADD Detalles nvarchar(1000) NULL;
...
INSERT INTO EMPRE_SA.[security].Security_Permissions_Roles
(Id_Role, Id_Permission, Estado)
VALUES(1, 1, N'ACTIVO');

INSERT INTO EMPRE_SA.[security].Security_Users (
        Nombres,
        Estado,
        Descripcion,
        Password,
...
INSERT INTO EMPRE_SA.[security].Security_Users_Roles
(Id_Role, Id_User, Estado)
VALUES(1, 1, N'ACTIVO');

INSERT INTO EMPRE_SA.[security].Tbl_Profile
