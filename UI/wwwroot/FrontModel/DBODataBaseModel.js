...
class Recibos extends EntityClass {
	...
	consecutivo = { type: "number", hidden: true  };
	temporal = { type: "checkbox"  };
	numero_contrato = { type: "number", hidden: true , disabled: true};
	monto = { type: "string" , disabled: true};
	saldo_actual_cordobas = { type: "string" , disabled: true};
	saldo_actual_dolares = { type: "string" , disabled: true};
	plazo = { type: "string" , disabled: true};
	interes_cargos = { type: "string" , disabled: true};
	tasa_cambio = { type: "string", hiddenInTable: true , disabled: true};
	tasa_cambio_compra = { type: "string", hiddenInTable: true , disabled: true};
	interes_demas_cargos_pagar_cordobas = { type: "string", hiddenInTable: true , disabled: true};
	interes_demas_cargos_pagar_dolares = { type: "string", hiddenInTable: true , disabled: true};
	abono_capital_cordobas = { type: "string", hiddenInTable: true , disabled: true};
	abono_capital_dolares = { type: "string", hiddenInTable: true , disabled: true};
	cuota_pagar_cordobas = { type: "string", hiddenInTable: true , disabled: true};
	cuota_pagar_dolares = { type: "string", hiddenInTable: true , disabled: true};
	mora_cordobas = { type: "string", hiddenInTable: true , disabled: true};
	mora_dolares = { type: "string", hiddenInTable: true , disabled: true};
	mora_interes_cordobas = { type: "string", hiddenInTable: true , disabled: true};
	mora_interes_dolares = { type: "string", hiddenInTable: true , disabled: true};
	total_cordobas = { type: "string", hiddenInTable: true , disabled: true};
