...
class Tbl_Factura_ModelComponent extends EntityClass {
    ...
    CreateContrato(contrato, ObjectF, interes, tasa) {
        ...
        ObjectF.Datos_Financiamiento.Cuota_Fija_Cordobas = contrato.Transaction_Contratos.cuotafija_dolares;
    }
    ...
    */
    ...
    CalculeTotal(EditObject, form) {
        ...
        for (const detalle of EditObject.Detalle_Factura) {
            form.ModelObject.Detalle_Factura.ModelObject.UpdateDetalle(EditObject, detalle);
