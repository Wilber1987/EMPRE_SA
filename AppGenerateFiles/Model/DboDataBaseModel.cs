...
namespace DataBaseModel
{
    ...
    public class Catalogo_Agentes : EntityClass
    {
        ...
        [OneToMany(TableName = "Transaction_Contratos_old", KeyColumn = "id_agente", ForeignKeyColumn = "id_agente")]
    ...
    public class Recibos : EntityClass
    {
        ...
        [ManyToOne(TableName = "Transaction_Contratos_old", KeyColumn = "numero_contrato", ForeignKeyColumn = "numero_contrato")]
        public Transaction_Contratos_old? Transaction_Contratos_old { get; set; }
    }
    ...
    public class Catalogo_Clientes : EntityClass
    {
        ...
        [OneToMany(TableName = "Transaction_Contratos_old", KeyColumn = "codigo_cliente", ForeignKeyColumn = "codigo_cliente")]
        public List<Transaction_Contratos_old>? Transaction_Contratos_old { get; set; }
    }
    ...
    public class Transaction_Contratos_old : EntityClass
    {
        ...
        public List<Detail_Prendas>? Detail_Prendas { get; set; }
        [OneToMany(TableName = "Recibos", KeyColumn = "numero_contrato", ForeignKeyColumn = "numero_contrato")]
        ...
        [OneToMany(TableName = "Transaction_Facturas_old", KeyColumn = "numero_contrato", ForeignKeyColumn = "numero_contrato")]
    ...
    public class Transaction_Facturas_old : EntityClass
    {
        [PrimaryKey(Identity = true)]
