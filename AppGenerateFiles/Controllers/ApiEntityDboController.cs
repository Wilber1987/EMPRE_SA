...
namespace API.Controllers {
   ...
   public class  ApiEntityDboController : ControllerBase {
       ...
       //Transaction_Facturas_old
       [HttpPost]
       [AuthController]
       public List<Transaction_Facturas_old> getTransaction_Facturas_old(Transaction_Facturas_old Inst) {
           return Inst.Get<Transaction_Facturas_old>();
       }
       [HttpPost]
       [AuthController]
       public object saveTransaction_Facturas_old(Transaction_Facturas_old inst) {
           return inst.Save();
       }
       [HttpPost]
       [AuthController]
       public object updateTransaction_Facturas_old(Transaction_Facturas_old inst) {
           return inst.Update();
       }
   }
}
