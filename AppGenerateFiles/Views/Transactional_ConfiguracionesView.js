...
class Transactional_ConfiguracionesView extends HTMLElement {
   ...
   Draw = async () => {
       ...
       this.MainComponent = new WTableComponent({ ModelObject: model, Dataset: dataset, Options: {
           Add: true, UrlAdd: "../api/ApiEntityADMINISTRATIVE_ACCESS/saveTransactional_Configuraciones",
           Edit: true, UrlUpdate: "../api/ApiEntityADMINISTRATIVE_ACCESS/updateTransactional_Configuraciones",
           Search: true, UrlSearch: "../api/ApiEntityADMINISTRATIVE_ACCESS/getTransactional_Configuraciones"
       }})
...
window.addEventListener('load', async () => {  MainBody.append(new Transactional_ConfiguracionesView())  })
